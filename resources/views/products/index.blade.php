...
<h2 class="font-bold text-3xl text-amber-500">Products</h2>
    ...
    <tbody>
        ...
        <tr class="text-center">
            ...
            <td class="border p-3">
                ...
                <a href="{{route('products.delete',$product->id)}}" class="bg-red-500 text-white p-2 rounded-lg" onclick="return confirm('Are you sure to delete?')">Delete</a>
