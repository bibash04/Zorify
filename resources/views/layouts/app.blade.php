...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased">
        ...
        <div class="fixed top-4 right-4 rounded-lg shadow-md bg-blue-600 text-white px-5" id="message">
            <p>{{session('success')}}</p>
        </div>
        <script>
            setTimeout(() => {
        ...
        <div class="flex">
            <div class="w-56 h-screen bg-gray-100 shadow">\
                <img src="https://s3.amazonaws.com/logos-brandpa-com/images/15f8ed0f7c1ffb6e99df85bf521f7426.png" alt="" class="p-2 m-2 w-10/12 mx-auto mt-2 bg-white rounded-lg shadow-lg">
                <div class="mt-5">
                    ...
                    <a href="" class="text-xl block pl-4 p-2 m-2 border-b border-amber-600 hover:bg-amber-600 hover:text-white">Logouts</a>
